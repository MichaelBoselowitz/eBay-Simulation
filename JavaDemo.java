...
public class JavaDemo
{
  ...
  public JavaDemo()
  {
    ...
    try blocks*/
    username = "mjb162"; //This is your username in oracle
    password = "3580903"; //This is your password in oracle
    try{
      ...
      String url = "jdbc:oracle:thin:@db.cs.pitt.edu:1521:dbclass"; 
    ...
    {
      System.out.println("Error running the sample query.  Machine Error: " +
            Ex.toString());
    }
